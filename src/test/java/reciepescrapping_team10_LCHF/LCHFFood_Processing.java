...
public class LCHFFood_Processing {
	...
	public static void extractRecipe() throws InterruptedException {
		...
		List<String> add = Arrays.asList(new String[] {"Steam","Steamed Snacks" ,"Boiled"});
			...
			for (Map.Entry<String, String> recipeIdUrlEntry : recipeIdUrls.entrySet()) {
				...
				try {
					...
					//	System.out.println("Recipe ID: " + recipeId);
						...
						// Recipe id
						try {
							writeOutput.setCellData("LCHFFoodProcessing", rowCounter, 0, recipeId);
						} catch (Exception e) {
							e.printStackTrace();
						}
						// Recipe Name
						try {
							...
							writeOutput.setCellData("LCHFFoodProcessing", rowCounter, 1, recipeTitle.getText());
						} catch (Exception e) {
							e.printStackTrace();
						}
						// Recipe Category
						try {
							...
							writeOutput.setCellData("LCHFFoodProcessing", rowCounter, 2, recipeCategory.getText());
						} catch (Exception e) {
							e.printStackTrace();
						}
						// Food Category
						try {
							...
							writeOutput.setCellData("LCHFFoodProcessing", rowCounter, 3, foodCategory.getText());
						} catch (Exception e) {
							e.printStackTrace();
						}
						// Ingredients
						try {
							...
							writeOutput.setCellData("LCHFFoodProcessing", rowCounter, 4, nameOfIngredients.getText());
						} catch (Exception e) {
							e.printStackTrace();
						}
						// Preparation Time
						try {
							...
							writeOutput.setCellData("LCHFFoodProcessing", rowCounter, 5, preparationTime.getText());
						} catch (Exception e) {
							e.printStackTrace();
						}
						// Cook Time
						try {
							...
							writeOutput.setCellData("LCHFFoodProcessing", rowCounter, 6, cookTime.getText());
						} catch (Exception e) {
							e.printStackTrace();
						}
						// Preparation Method
						try {
							...
							writeOutput.setCellData("LCHFFoodProcessing", rowCounter, 7, prepMethod.getText());
						} catch (Exception e) {
							e.printStackTrace();
						}
						// Nutrients
						try {
							...
							writeOutput.setCellData("LCHFFoodProcessing", rowCounter, 8, nutrients.getText());
						} catch (Exception e) {
							e.printStackTrace();
						}
						// Recipe URL
						try {
							...
							writeOutput.setCellData("LCHFFoodProcessing", rowCounter, 9, recipeUrl);
						} catch (Exception e) {
							e.printStackTrace();
						}
						rowCounter++;
