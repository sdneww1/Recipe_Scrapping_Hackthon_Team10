							...
							try {
								if (isEliminated(eliminators)) {
									...
									try {
										...
										writeOutput.setCellData("LCHFElimination", rowCounter, 7, prepMethod.getText());
									...
									try {
										...
										writeOutput.setCellData("LCHFElimination", rowCounter, 8, nutrients.getText());
									...
									try {
										...
										writeOutput.setCellData("LCHFElimination", rowCounter, 9, recipeUrl);
									} catch (Exception e) {
