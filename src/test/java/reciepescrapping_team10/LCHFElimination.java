										...
										try {
											if (isEliminated(eliminators)) 
											{
												...
												try {
													...
													writeOutput.setCellData("LCHFElimination", rowCounter, 2, recipeCategory.getText());
												...
												try {
													...
													writeOutput.setCellData("LCHFElimination", rowCounter, 3, foodCategory.getText());
												...
												try {
													...
													writeOutput.setCellData("LCHFElimination", rowCounter, 4, nameOfIngredients.getText());
												...
												try {
													...
													writeOutput.setCellData("LCHFElimination", rowCounter, 5, preparationTime.getText());
