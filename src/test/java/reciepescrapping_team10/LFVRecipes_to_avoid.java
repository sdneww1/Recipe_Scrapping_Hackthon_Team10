							...
							try {
								if ((toAvoid(LFVRecipes_To_Avoid))) {
									...
									try {
										...
										writeOutput.setCellData("LFVRecipes_To_Avoid", rowCounter, 2,
									...
									try {
										...
										writeOutput.setCellData("LFVRecipes_To_Avoid", rowCounter, 3,
									...
									try {
										...
										writeOutput.setCellData("LFVRecipes_To_Avoid", rowCounter, 6, tags.getText());
									...
									try {
										...
										writeOutput.setCellData("LFVRecipes_To_Avoid", rowCounter, 7,
												prepMethod.getText());
									...
									try {
										...
										writeOutput.setCellData("LFVRecipes_To_Avoid", rowCounter, 9, recipeUrl);
									} catch (Exception e) {
